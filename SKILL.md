...
shot-progress-asset-dependency-manager の作業手順です。
...
- asset は `dist/shot-progress-asset-dependency-manager-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
